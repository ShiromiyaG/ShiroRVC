...
class DSCA_ResUNet_v3(nn.Module):
    def __init__(self, n_channels=2, n_classes=1):
        ...
        # enc3/enc4 use asymmetric (2, 1) strides to compress Frequency more than Time.
        ...
        # Deep supervision heads, at dec2/dec3
        self.ds_out2 = nn.Conv2d(64, n_classes, kernel_size=1)
        self.ds_out3 = nn.Conv2d(128, n_classes, kernel_size=1)
    ...
    def forward(self, x):
        ...
        if self.training:
            # Aux outputs for deep supervision loss.
