...
-- the file is loaded to CPU and immediately copied into fp32 parameters.
    ...
    python tools/pretrain/clean_pretrain.py --model-dir logs/pretrain --weights live
    python tools/pretrain/clean_pretrain.py --generator logs/pretrain/G_306194.pth \\
