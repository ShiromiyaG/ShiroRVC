...
So the intended order is:
    ...
    tools/pretrain/graft_vocoder_pretrain.py     -> a pretrain G/D pair
...
USAGE
-----
    python tools/pretrain/pretrain_stage0_vocoder.py --model vctk-vocoder \\
...
def main() -> int:
    ...
    print(
        f"\nNext: python tools/pretrain/graft_vocoder_pretrain.py --model {directory.name} "
