...
Usage::
    ...
    python tools/pretrain/widen_speaker_table.py logs/pretrain/G_194326.pth --speakers 80
    python tools/pretrain/widen_speaker_table.py logs/pretrain/G_194326.pth --from-log logs/pretrain-v2
