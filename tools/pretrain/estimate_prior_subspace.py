...
Usage::
    ...
    python tools/pretrain/estimate_prior_subspace.py logs/pretrain-contentvec/G_262218.pth
    python tools/pretrain/estimate_prior_subspace.py logs/weights/model.pth --model pretrain-contentvec
"""
