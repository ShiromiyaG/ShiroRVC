...
def rmvpe_high_register_tab():
    ...
    with gr.Accordion(_("RMVPE high-register correction"), open=False):
        enabled = gr.Checkbox(
            label=_("Enable RMVPE high-register correction"),
            info=_(
